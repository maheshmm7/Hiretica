...
from config.settings import ReadinessThresholdsConfig, BehaviorWeightsConfig
...
def test_behavior_scoring():
    weights = BehaviorWeightsConfig(engagement=0.4, availability=0.4, profile_quality=0.2)
